...
for (let supplyItem of supplyChanges) {
	if (supplyItem > 0) {
		console.log('7. Showing supplyChanges with "for of" loop', supplyItem);
	}
	if (supplyItem === 0) {
		console.log('7. Showing supplyChanges with "for of" loop', supplyItem);
	}
...
console.log('9. Filling boxes with a "while" loop', numberOfBoxesFilled);
console.log("remainder", parts);
